...
interface Props {
  ...
  section: 'contenido' | 'fuentes' | 'historias' | 'radar';
  onSection: (s: 'contenido' | 'fuentes' | 'historias' | 'radar') => void;
  mode: 'organico' | 'ads';
    ...
    <aside className="w-56 shrink-0 border-r border-line bg-white min-h-screen px-3 py-5 hidden md:block">
      ...
      <nav className="flex flex-col gap-0.5">
        ...
        <button
          ...
          className={`flex items-center gap-2 px-2.5 py-2 rounded-lg text-sm transition-colors ${
            section === 'radar' ? 'bg-accent-soft text-accent font-medium' : 'hover:bg-gray-50 text-gray-700'
          }`}
        >
