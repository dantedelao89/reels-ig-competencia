...
// Dispara en el scraper el alta/scrape de UN anunciante a partir de cualquier link de Facebook
// (post, anuncio compartido, página) pegado en DISECTA.
export async function POST(req: NextRequest) {
  ...
  try {
    const res = await fetch(`${scraper.replace(/\/$/, '')}/scrape-ad-url`, {
      method: 'POST',
